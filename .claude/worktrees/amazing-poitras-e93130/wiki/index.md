# Wiki Index
*Last updated: 2026-04-18 — 119 pages, 5 sources*
...
| Page | Summary | Date |
|------|---------|------|
| [[sources/dc-brain-dump-001]] | Voice transcript brain dump — complete DC job workflow, end-to-end | 2026-04-14 |
| [[sources/extra-questions-001]] | Answers to all open questions across 20+ wiki pages — Round 4 Q&A | 2026-04-14 |
...
## Departments
*No department pages yet — to be built as brain dumps come in from other roles.*
...
| [[processes/census-load]] | How a census file becomes rows in CORP.EMPLOYEE + EE_BEN_ADDRESS; QA gap audits before downstream loads unblock — **needs-review** | 3 |
| [[processes/investment-elections-load]] | Migrating fund elections + Save Express + E-Statement + secure-data from outgoing case to new case — **needs-review** | 3 |
| [[processes/loan-takeover]] | Building takeover loan headers + per-source splits + HOLB history; pre-liquidation snapshot for liquidation analyst — **needs-review** | 3 |
| [[processes/prod-support-ticket]] | How to open an AWD ticket to Prod Support with isolating query + desired end state; verification + close — **needs-review** | 2 |
| [[processes/balance-import-cash]] | Posting participant balances after a cash conversion — AE liquidation, Informatica mp_part_balance, Process Immediate + Batch, ROC dummy reversal — **needs-review** | 4 |
| [[processes/balance-import-mapping]] | Posting participant balances after a mapping conversion — Online + No Hold only; trades already out on Day of Wire — **needs-review** | 4 |
| [[processes/balance-import-tik]] | Posting participant balances after a TIK conversion — update Matt O'Connell tracker, Informatica fills Bill Remit detail, Online + No Hold — **needs-review** | 4 |
...
|------|-----------|---------|
| [[glossary/nsa]] | NSA — New Sale Announcement; triggers COM workflow | 1 |
| [[glossary/csr]] | CSR — Conversion Summary Report; Quality Consultant deliverable at go-live | 1 |
| [[glossary/vef]] | VEF — Vendor Expense Form; routed by COM through advisor, client, and L&C | 1 |
| [[glossary/awd]] | AWD — Automatic Work Distribution; internal work-ticketing and routing system | 1 |
| [[glossary/ltpt]] | LTPT — Long-Term Part-Time; Secure Act 2.0 eligibility category effective Jan 1, 2025 | 1 |
| [[glossary/ssbt]] | SSBT — State Street Bank & Trust; external bank receiving plan wires; 4 PM EST cut-off | 1 |
| [[glossary/filespecrq]] | FILESPECRQ — AWD ticket type; DC submits at go-live to hand off incomplete payroll to Fiduciary Services | 1 |
| [[glossary/tm]] | TM — Transition Manager; legacy name for the COM role; all current references use COM | 1 |
...
| Page | Summary | Sources |
|------|---------|---------|
| [[entities/ellen-miller]] | Central routing contact — DC assignment, notice mailing, SF setup, go-live notification | 2 |
...
| [[entities/scott-vrba]] | Primary eligibility SME — go-to for complex eligibility rule questions | 1 |
| [[entities/eric-leytem]] | FTP Team key contact — handles final account setup and confirmation | 1 |
| [[entities/jen-curtin]] | Head of the FTP Team — authoritative go-to for internal payroll integration; COM notifies for 360° plans | 2 |
| [[entities/earl-sanford]] | Lead Data Consultant — primary training resource for new DCs; 25+ year TA veteran | 1 |
| [[entities/dave-shloat]] | Large Market data guru — Alteryx and Informatica authority; deep team resource | 1 |
...
| Page | Summary | Sources |
|------|---------|---------|
| [[concepts/balance-import]] | Hub: 3 balance import types (cash/mapping/TIK), CIT file structure, Informatica mp_part_balance, P3 mode rules — **needs-review** | 4 |

## Concepts — Core Data Domains
| Page | Summary | Sources |
|------|---------|---------|
| [[concepts/census]] | Employee-demographic master; SSN, name, dates, address; keys every downstream load — **needs-review** | 3 |
| [[concepts/investment-elections]] | Fund-allocation elections by source + QDIA default + Save Express / E-Statement / secure-data siblings — **needs-review** | 4 |
| [[concepts/roth]] | Roth money source, basis buckets, 5-year clock (RTH_CTRB_FST_YR) — **needs-review** | 2 |
| [[concepts/basis]] | Cost-basis buckets: pre-87/post-86 after-tax, Roth, Type 3/6, deemed-loan; EE_BASIS — **needs-review** | 3 |
| [[concepts/loans]] | Loan headers + per-source splits + repayments + HOLB; IRS 50%/$50K cap mechanics — **needs-review** | 3 |
| [[concepts/awd]] | Full AWD concept: work types, queues, Prod Support / FILESPECRQ / Reversal / Rebook tickets — **needs-review** | 3 |
...
| [[concepts/vef]] | Vendor Expense Form; routes through advisor → client → L&C setup | 1 |
