...
/* Folder tree — crisp sidebar styling */
...
.folder > ul li:hover {
  background: color-mix(in srgb, var(--fg) 10%, var(--bg-2));
...
/* per-folder accent colors used by folder icons (retained for compat; icon tile hidden) */
