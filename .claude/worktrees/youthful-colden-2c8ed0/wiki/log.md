...
## [2026-04-18] edit | Merge "Data Consultant" into "Large Market Data Consultant"
- Pages updated (9):
  - `entities/internal-teams` — section header updated: "DC — Data Consultant" → "DC — Large Market Data Consultant"
  - `overview` — role name updated to "Large Market Data Consultant (LM DC)"
  - `concepts/dc-onboarding-workflow` — opening description updated
  - `entities/earl-sanford` — title updated to "Lead Large Market Data Consultant" throughout
  - `entities/ellen-miller` — "Data Consultants" → "Large Market Data Consultants"
  - `onboarding/com` — "The Data Consultant" → "The Large Market Data Consultant"
  - `sources/dc-brain-dump-001` — source description updated
  - `index` — earl-sanford summary updated to reflect new title
- Notes: All standalone uses of "Data Consultant" as a role name now read "Large Market Data Consultant." The abbreviation "DC" is retained throughout as the accepted shorthand. File paths in sources (e.g., `S:\CIT\Data Consultants\`) left unchanged as they reflect actual system paths.
