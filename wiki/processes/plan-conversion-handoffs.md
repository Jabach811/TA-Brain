...
- **COM trigger:** [[ellen-miller]] (or sales) issues an [[concepts/nsa]] (New Sale Announcement) → COM receives it → COM creates project plan and schedules kickoffs
...
### 1. Assignment → DC
- **From:** [[ellen-miller]] → manager → [[roles/lm-dc]]
...
- **From:** [[roles/lm-dc]] → [[roles/com]] → [[qa]] + [[tc]]
...
- **From:** [[roles/lm-dc]] → [[matt-oconnell]]
...
- **From:** [[roles/lm-dc]] → [[cashiering]] (heads-up, day before)
- **From:** Prior record keeper → wire → [[cashiering]]
- **From:** [[cashiering]] → [[roles/lm-dc]] (wire receipt + ref number)
...
### 7. Eligibility Gate
- **From:** [[roles/lm-dc]] → [[qa]] + [[tc]] + [[roles/com]] (notification)
...
### 10. NSA → COM Kickoff
- **From:** Sales / business development → [[roles/com]]
- **What moves:** [[concepts/nsa]] (New Sale Announcement)
...
- **From:** Plan Services → [[roles/com]] → [[ellen-miller]] → docs team
...
- **From:** [[roles/com]] → plan sponsor + prior carrier
...
- **From:** [[roles/com]] → plan sponsor (approval) → [[ellen-miller]] (mailing)
...
- **From:** [[roles/com]] → client → [[roles/com]] → [[roles/lm-dc]]
...
- **From:** [[roles/com]] → client → [[roles/com]] → [[tc]]
...
### 16. RDD Form Loop
- **From:** [[tc]] → [[roles/com]] → client → [[roles/com]] → [[tc]]
- **Trigger:** Payroll setup phase
- **What moves:** [[rdd-form]]
- **Risk:** Client slow to return; COM must track and follow up; TC cannot proceed without it

### 17. Early Access Activation
- **From:** [[roles/com]] → [[roles/lm-dc]] (template request) → client (file completion) → [[roles/lm-dc]] (file load) → [[tc]] (activation)
...
- **From:** [[roles/lm-dc]] → [[roles/com]] → client
...
### 19. CSR Delivery
- **From:** Quality Consultant → [[roles/com]] → client
- **Trigger:** Go-live
- **What moves:** [[concepts/csr]] (Conversion Summary Report)
- **Risk:** COM cannot complete go-live close-out until CSR is received; if QC delays, COM must follow up

### 20. Go-Live Close-Out
- **From:** [[roles/com]] → internal team + client + [[ellen-miller]] + [[nbi]]
...
- **From:** [[roles/lm-dc]] → Fiduciary Services; [[roles/com]] → Account Manager
...
- **What moves:** Case notes, system audit evidence, Outsourcing Addendum review, P3 tab checks, Fee Disclosure Notice checklist review, initial notice review, DDOL/VRU/PSD access status, remittance/admin guidance, special-service setup, participant website audit results, and final subpack
- **TC action:** Confirms administrative procedures are documented, provides administration details to Remit Loaders/Processors/Contact Center/AM, and verifies participant/sponsor access is ready before activation
...
- **See:** [[tc-conversion-timeline]], [[tc-details-from-dan]], [[go-live-checklist]], [[case-notes-template]]
## Failure Modes
